    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="max-w-3xl mx-auto">
        <Accordion type="single" collapsible className="w-full space-y-4">
          <AccordionItem value="item-1" className="bg-neutral-100/50 dark:bg-neutral-950/50 rounded-lg border border-neutral-200 dark:border-neutral-800 px-6">
          ...
          <AccordionItem value="item-2" className="bg-neutral-100/50 dark:bg-neutral-950/50 rounded-lg border border-neutral-200 dark:border-neutral-800 px-6">
          ...
          <AccordionItem value="item-3" className="bg-neutral-100/50 dark:bg-neutral-950/50 rounded-lg border border-neutral-200 dark:border-neutral-800 px-6">
            <AccordionTrigger className="text-neutral-900 dark:text-white hover:text-neutral-600 dark:hover:text-neutral-300 text-left">
          ...
          <AccordionItem value="item-4" className="bg-neutral-100/50 dark:bg-neutral-950/50 rounded-lg border border-neutral-200 dark:border-neutral-800 px-6">
            <AccordionTrigger className="text-neutral-900 dark:text-white hover:text-neutral-600 dark:hover:text-neutral-300 text-left">
          ...
          <AccordionItem value="item-5" className="bg-neutral-100/50 dark:bg-neutral-950/50 rounded-lg border border-neutral-200 dark:border-neutral-800 px-6">
            <AccordionTrigger className="text-neutral-900 dark:text-white hover:text-neutral-600 dark:hover:text-neutral-300 text-left">
          ...
          <AccordionItem value="item-6" className="bg-neutral-100/50 dark:bg-neutral-950/50 rounded-lg border border-neutral-200 dark:border-neutral-800 px-6">
            <AccordionTrigger className="text-neutral-900 dark:text-white hover:text-neutral-600 dark:hover:text-neutral-300 text-left">
