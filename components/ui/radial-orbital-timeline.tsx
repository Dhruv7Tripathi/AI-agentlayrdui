...
export default function RadialOrbitalTimeline({
  ...
  const calculateNodePosition = (index: number, total: number) => {
    ...
    const x = parseFloat((radius * Math.cos(radian) + centerOffset.x).toFixed(2));
    const y = parseFloat((radius * Math.sin(radian) + centerOffset.y).toFixed(2));
  ...
  return (
    <div
      className="w-full h-150 flex flex-col items-center justify-center bg-white dark:bg-neutral-950 overflow-hidden"
      ref={containerRef}
